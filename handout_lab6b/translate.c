...
{   if(strcmp(Temp_labelstring(funLabel),"printi")!=0&&strcmp(Temp_labelstring(funLabel),"print")!=0
	    &&strcmp(Temp_labelstring(funLabel),"ord")!=0&&strcmp(Temp_labelstring(funLabel),"getchar")!=0
	     &&strcmp(Temp_labelstring(funLabel),"size")!=0&&strcmp(Temp_labelstring(funLabel),"chr")!=0
	      &&strcmp(Temp_labelstring(funLabel),"substring")!=0&&strcmp(Temp_labelstring(funLabel),"int")!=0
	       &&strcmp(Temp_labelstring(funLabel),"not")!=0&&strcmp(Temp_labelstring(funLabel),"exit")!=0
	    ){
